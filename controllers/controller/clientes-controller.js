                    ...
                    if(idxPC!=-1){
                       let idxResult=  Object.keys(pruebaContestada).indexOf('resultados');
                        if(idxResult!=-1){
                            ...
                            if(Number.parseInt( resultados.porcentajes.buenas)> Number.parseInt(pruebaItems.porcentajeAprovacion) || Number.parseInt( resultados.porcentajes.buenas)== Number.parseInt(pruebaItems.porcentajeAprovacion)){
...
function fechaHoy(){
    return new Promise((resolve,reject)=>{
        ...
        let server = ['cl.pool.ntp.org', 'south-america.pool.ntp.org', 'ntp.shoa.cl'];
            ...
            ntpClient.getNetworkTime(server[0], 123, (err, data) => {
                jData = {
